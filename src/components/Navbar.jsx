...
const Navbar = () => {
  ...
  return (
    ...
    text-xl items-center px-12 h-20'>
        ...
        <a href="#">Mohan Polamarasetty</a>

        <ul className='hidden md:flex gap-12 z-10 cursor-pointer'>
            <li><Link to="hero" smooth={true} offset={50} duration={500}>About Me</Link></li>
        ...
        >
            <ul className='font-semibold text-4xl space-y-8 mt-24 text-center'>
                <li><Link to="hero" onClick={closeNav} smooth={true} offset={50} duration={500}>About</Link></li>
